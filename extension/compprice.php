...
//Insert into table 1 
	try {   
		...
		$sql1 = "INSERT INTO tbl_competitor_prices (c_route, c_outlet, competitor, product, our_price, competitor_price, date)
		VALUES ('" .$rid. "','" .$pid. "', '" .$competitor. "', '" .$product. "', '" .$oprice. "', '" .$cprice. "', '" .$date. "')";
