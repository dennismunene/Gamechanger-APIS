...
//Insert into table 1 
	try {   
		...
		$sql1 = "INSERT INTO tbl_location (agent, date, time_in, purpose, longitude, latitude, time_out, comments)
		VALUES ('" .$username. "','" .$rid. "','" .$date. "', '" .$competitor. "', '" .$product. "', '" .$oprice. "', '" .$cprice. "', '" .$pid. "')";
